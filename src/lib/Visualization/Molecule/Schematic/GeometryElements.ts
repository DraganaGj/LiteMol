...
namespace LiteMol.Visualization.Molecule.Schematic.Geometry {
    ...
    export class SchematicGeometryState {
        residueIndex = 0;
        ...
        constructor(public params: SchematicGeometryParams, private residueCount: number) {
            this.vertexMap = new Selection.VertexMapBuilder(residueCount);
        }
    }

    function makeStrandLineTemplate(ctx: ContextSchematic) {
    ...
    function renderGap(ctx: ContextSchematic, unitA: CartoonAsymUnit, unitB: CartoonAsymUnit) {
    ...
    function renderDirectionCone(ctx: ContextSchematic, unit: CartoonAsymUnit, radius: number, residueIndex: number) {
    ...
    export async function buildUnitsAsync(ctx: ContextSchematic): Promise<void> {
    ...
    export function createGeometry(ctx: ContextSchematic) {
        let state = ctx.state;
    ...
    export class BuilderSchematic {
        ...
        addSheet(element: CartoonAsymUnit, state: SchematicGeometryState, isStart: boolean, isEnd: boolean) {
            let verticesDone = state.verticesDone,
                params = state.params,
        ...
        addSheepCapSection(state: SchematicGeometryState, p1: THREE.Vector3, p2: THREE.Vector3, p3: THREE.Vector3, p4: THREE.Vector3) {
